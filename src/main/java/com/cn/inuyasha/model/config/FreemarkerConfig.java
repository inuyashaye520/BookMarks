package com.cn.inuyasha.model.config;

import com.cn.inuyasha.model.service.ConfigService;
import com.cn.inuyasha.model.session.shiroTag.ShiroTags;
...
public class FreemarkerConfig extends FreeMarkerAutoConfiguration.FreeMarkerWebConfiguration implements ServletContextAware {
    ...
    public void setServletContext(ServletContext context) {
        ...
        try {
            ...
            configuration.setSharedVariable("Config", configService);
